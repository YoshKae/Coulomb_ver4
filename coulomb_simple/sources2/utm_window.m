...
global COORD_VARS
if isempty(COORD_VARS.ZERO_LON)
    % デフォルト値
    COORD_VARS.ZERO_LON = 130.2;
end
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
    set(hObject,'BackgroundColor','white');
end
h = findobj('Tag','edit_center_lon');
set(h,'String',num2str(COORD_VARS.ZERO_LON,'%8.3f'));
...
% この関数は、テキストフィールドに初期値を設定します。
global COORD_VARS
if isempty(COORD_VARS.MIN_LON) | COORD_VARS.MIN_LON == 0
    % デフォルト値
    COORD_VARS.MIN_LON = 129.5;
end
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
    set(hObject,'BackgroundColor','white');
end
h = findobj('Tag','edit_min_lon');
set(h,'String',num2str(COORD_VARS.MIN_LON,'%8.3f'));
...
% この関数は、テキストフィールドに初期値を設定します。
global COORD_VARS
if isempty(COORD_VARS.MAX_LON)
    % デフォルト値
    COORD_VARS.MAX_LON = 131.0;
end
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
    set(hObject,'BackgroundColor','white');
end
h = findobj('Tag','edit_max_lon');
set(h,'String',num2str(COORD_VARS.MAX_LON,'%8.3f'));
...
% この関数は、テキストフィールドに初期値を設定します。
global COORD_VARS
if isempty(ZCOORD_VARS.ERO_LAT)
    % デフォルト値
    COORD_VARS.ZERO_LAT = 33.8;
end
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
    set(hObject,'BackgroundColor','white');
end
h = findobj('Tag','edit_center_lat');
set(h,'String',num2str(COORD_VARS.ZERO_LAT,'%8.3f'));
...
% この関数は、テキストフィールドに初期値を設定します。
global COORD_VARS
if isempty(COORD_VARS.MIN_LAT) | COORD_VARS.MIN_LAT == 0
    % デフォルト値
    COORD_VARS.MIN_LAT = 33.0;
end
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
    set(hObject,'BackgroundColor','white');
end
h = findobj('Tag','edit_min_lat');
set(h,'String',num2str(COORD_VARS.MIN_LAT,'%8.3f'));
...
% この関数は、テキストフィールドに初期値を設定します。
global COORD_VARS
if isempty(COORD_VARS.MAX_LAT)
    % デフォルト値
    COORD_VARS.MAX_LAT = 34.5;
end
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
    set(hObject,'BackgroundColor','white');
end
h = findobj('Tag','edit_max_lat');
set(h,'String',num2str(COORD_VARS.MAX_LAT,'%8.3f'));
...
INPUT_VARS.INUM = 1; % for counting (initialization) % カウント初期化のため
