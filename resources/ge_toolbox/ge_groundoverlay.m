function [output] = ge_groundoverlay( n_coord, s_coord, e_coord, w_coord , varargin )
% % ge_groundoverlay( n, s, e, w, varargin )
...
if( isempty( n_coord ) || isempty( s_coord ) || isempty( e_coord ) || isempty( w_coord ) )
...
header=['<GroundOverlay ',id_chars,'>',...
		...
		coords= [ sprintf('<north>%.6f</north>', n_coord),...
                sprintf('<south>%.6f</south>', s_coord),...
                sprintf('<east>%.6f</east>', e_coord),...
                sprintf('<west>%.6f</west>', w_coord)];
